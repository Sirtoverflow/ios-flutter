  ...
  void _loadSettings() async {
    ...
    setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'wss://vcwebrtc.voicecloud.vn:9443';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? 'sip:101@demo4.voicecloud.vn';
      _displayNameController.text =
          _preferences.getString('display_name') ?? '101';
      _passwordController.text = _preferences.getString('password') ?? 'j9rDWt';
